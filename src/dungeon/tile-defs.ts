...
export class TileDefs{
    public static floorDefs:IFloorTile[] = [
        {
            id:"acidic",texture:"acidic_floor", variants:4, floorType:FloorType.WALKABLE, variantBase:0
        },
        {
            id:"black_cobalt", texture:"black_cobalt", variants:12, floorType:FloorType.WALKABLE, variantBase:1, variant2Digit:true
        },
        {
